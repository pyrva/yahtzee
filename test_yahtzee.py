...
@pytest.mark.parametrize(
    "dice, expected", [([1, 1, 1, 2, 3], 0), ([1, 2, 3, 4, 5], 0), ([1, 1, 1, 1, 2], 6)]
)
...
@pytest.mark.parametrize(
    "dice, expected",
    [([1, 2, 3, 4, 1, 1], 30), ([1, 2, 1, 2, 1], 0), ([4, 5, 6, 3, 2], 30)],
)
...
@pytest.mark.parametrize(
    "dice, expected",
    [([1, 2, 3, 4, 5], 40), ([1, 2, 1, 2, 1], 0), ([2, 3, 4, 5, 6], 40)],
)
...
@pytest.mark.parametrize(
    "dice, expected",
    [([1, 2, 3, 4, 5], 15), ([1, 2, 1, 2, 1], 7), ([2, 3, 4, 5, 6], 20)],
)
...
@pytest.mark.parametrize(
    "dice, expected",
    [([1, 1, 1, 1, 1], 50), ([1, 2, 1, 2, 1], 0), ([2, 3, 4, 5, 6], 0)],
)
...
def test__all_scores_used(scores, complete):
    assert all_scores_used(scores) is complete
